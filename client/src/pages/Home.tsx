...
function CalendarGrid({ sessions, events, onSelect }: { sessions: { createdAt: Date }[]; events: { eventDate: string; title: string }[]; onSelect: (date: string) => void }) {
...
function HomePage({ pin, category, data }: { pin: string; category: Category; data: any }) {
  ...
  return <div className="space-y-4 pb-2">
    ...
    <Pomodoro pin={pin} />
    <CalendarGardenPager pin={pin} category={category} sessions={data.sessions} events={[...data.events, ...(data.personalEvents ?? [])]} />
